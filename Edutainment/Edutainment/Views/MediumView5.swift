...
//
/* Game Screen that asks 5 medium questions, the only thing that is changed from EasyView5 is the range of numbers being from 0-5 to instead 2-7 */

import SwiftUI
struct MediumView5: View {
