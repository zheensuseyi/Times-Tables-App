...
//
/* Game Screen that asks 5 hard questions, the only thing that is changed from EasyView5 is the range of numbers being from 0-5 to instead 2-12 */

import SwiftUI
struct HardView5: View {
